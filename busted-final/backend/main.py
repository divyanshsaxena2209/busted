...
from backend.routers import pincode
...
# CORS Configuration
# We explicitly list common frontend development origins.
# Using allow_credentials=True requires specific origins (no wildcards in some browser configs).
origins = [
