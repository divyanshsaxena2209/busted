    ...
    <div className="relative min-h-screen w-full overflow-x-hidden flex flex-col font-sans text-white">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center w-full px-4 md:px-8 py-6">
        ...
        <div className="w-full flex flex-col">
          ...
          {/* Login/Guest Buttons - EXTREME RIGHT - Only on Home */}
          {currentView === 'home' && (
            <div className="w-full flex justify-end mb-4 md:mb-0 relative z-30">
              <HomeActions 
          ...
          {/* BUSTED Heading (Centered) - Only show on Home, Login, Signup */}
          {(currentView === 'home' || currentView === 'login' || currentView === 'signup') && (
            <div className={`w-full flex justify-center transition-all duration-700 ${currentView !== 'home' ? 'mb-8 mt-4 md:mt-8 scale-75' : 'mb-48 mt-12 md:mt-32'}`}>
              <Header />
            </div>
          )}
          ...
          {(currentView === 'dashboard' || currentView === 'report-issue' || currentView === 'history' || currentView === 'upload-evidence' || currentView === 'complaint-preview') && (
            <div className="w-full relative animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* Dynamic Police Light Glow (Background) */}
              <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-blue-600/15 rounded-full blur-3xl pointer-events-none animate-pulse-slow -translate-x-1/2 -translate-y-1/2 mix-blend-screen"></div>
              <div className="absolute top-40 right-0 w-[500px] h-[500px] bg-red-600/15 rounded-full blur-3xl pointer-events-none animate-pulse-slow delay-1000 translate-x-1/3 mix-blend-screen"></div>

              {/* Shared Top Header for Internal Views */}
              <div className="px-6 md:px-12 mb-8 flex justify-between items-center relative z-20">
              ...
              {currentView === 'dashboard' && (
                <div className="w-full px-6 md:px-12 pb-20 relative z-10">
                  ...
                  <div className={`grid grid-cols-1 ${!user?.isGuest ? 'xl:grid-cols-2' : ''} gap-16 xl:gap-24 relative z-10`}>
                    ...
                    {/* Section 2: Traffic Police Updates - Full width for Guest, Column for Login */}
